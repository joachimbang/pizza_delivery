...
import CardPizzaAdmin from "../../components/admin/CardPizzaAdmin";
import TitleButtonCommand from "../../components/admin/TitleButtonCommand";

const ListPizzaAdmin = () => {
  return (
    <>
      <div className="flex h-screen bg-gradient-to-br from-[#f0f4f8] to-[#dbe5ed]">
        ...
        <main className="flex-1 p-6 overflow-y-auto">
          {/* <Header /> */}
          <HeaderAdmin/>
          <TitleButtonCommand title={"Lists of pizza available"} />
          <motion.div
